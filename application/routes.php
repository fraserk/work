...
Route::get('/',array('as'=>'home','uses'=>'job@index'));
Route::get('job/(:num)',array('as'=>'detail','uses'=>'job@detail'));
Route::get('job/new',array('as'=>'new','uses'=>'job@new'));
...
Route::get('user/login',array('as'=>'login','uses'=>'user@login'));
Route::POST('user/logincheck', array('uses'=>'user@logincheck'));
...
{
	if (Auth::guest()) return Redirect::to_route('login')->with('message','Please login');
});